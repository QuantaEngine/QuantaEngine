"""Execute and archive the QuantaEngine remediation quality gates."""
...
RECORD = ROOT / "plans/codebase-remediation-2026-06-21/records/remediation-evidence.json"
...
def wheel_smoke() -> dict[str, object]:
    ...
    started = time.monotonic()
    with tempfile.TemporaryDirectory(prefix="quanta-wheel-") as temp:
        temp_path = Path(temp)
        ...
        commands = [
            ...
            [
                ...
                "-c",
                (
                    "import cosmogenesis, quanta_engine, quantaengine, quantaengine_lattice; "
                    "assert {cosmogenesis.__version__, quanta_engine.__version__, "
                    "quantaengine.__version__, quantaengine_lattice.__version__} == {'0.3.0'}"
                ),
            ],
            [
                str(python),

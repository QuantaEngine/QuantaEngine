...
finding → 改动代码 → 回归测试 → 验收要点。Phase A/B/C/D 均已实现，待最终复审。
...
| `QE-2026-107` | D (fixed) | `docs/design/DEPRECATION.md` | `test_remediation_b.py::test_deprecation_schedule_documented` | lattice 定位与 1.0 移除时间表存在 |
...
| `QE-2026-109` | D (fixed) | `plans/2026-06-21-GENESIS_ARENA_V2_PARALLEL_ADVERSARIAL.md` | （文档检查） | 顶部有 superseded 横幅指向 REPO_STRUCTURE |

"""Tests for the GenesisArena parallel adversarial platform."""

from __future__ import annotations

import pytest

from cosmogenesis import ParameterVector
from genesis_arena import engines, run_duel, run_tournament
from genesis_arena import scoring
from genesis_arena.agents import TheoryAgent
from genesis_arena.cards import (
    ChallengeCard,
    ChallengeType,
    DefenseStance,
    JudgeDecision,
...
from genesis_arena.evolution import evolve
from genesis_arena.judge import Judge
from genesis_arena.patchgate import PatchGate
from genesis_arena.theory import TheoryRegistry, load_theory
from genesis_arena.verifier import Verifier
...
def test_fork_preserves_parent_and_never_merges(registry):
    ...
    from genesis_arena.cards import JudgeResult
